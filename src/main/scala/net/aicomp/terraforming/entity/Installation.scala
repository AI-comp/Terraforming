...
object Installation {
  ...
  val robotmaker = new Installation("robotmaker", 25, 4, 3)
  val excavator = new Installation("excavator", 20, 5, 3)
  ...
  val buildables = List(robotmaker, excavator, attack, shelter, bridge, house, town)
}
